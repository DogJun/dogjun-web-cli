...
let UserController = (_dec = (0, _awilixKoa.route)('/user'), _dec2 = (0, _awilixKoa.route)('/:id'), _dec3 = (0, _awilixKoa.GET)(), _dec(_class = (_class2 = class UserController {
  constructor({
    userService
  }) {
  ...
  async getUser(ctx, next) {
    ...
    ctx.body = await ctx.render('user/pages/index', {
      data: result
    });
  }
